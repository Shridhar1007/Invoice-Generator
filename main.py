...
def generate_invoice():
    ...
    doc_name = "new_invoice_" + name.replace(" ", "_") + datetime.datetime.now().strftime("%Y-%m-%d-%H%M%S") + ".docx"
    doc.save(doc_name)
...
address_label.grid(row=2, column=0, columnspan=3)
address_entry = tkinter.Entry(frame, width=50)
address_entry.grid(row=3, column=0, columnspan=3)
